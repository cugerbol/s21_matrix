...
START_TEST(s21_remove_matrix_test_2) { s21_remove_matrix(NULL); }
END_TEST

START_TEST(s21_remove_matrix_test_3) { s21_remove_matrix(0); }
END_TEST
...
int main(void) {
  ...
  Suite *s2 = suite_create("s21_create_matrix");
  TCase *tc2_1 = tcase_create("s21_create_matrix");
  Suite *s3 = suite_create("s21_determinant_matrix");
  TCase *tc3_1 = tcase_create("s21_determinant_matrix");
  Suite *s4 = suite_create("s21_eq_matrix");
  TCase *tc4_1 = tcase_create("s21_eq_matrix");
  Suite *s5 = suite_create("s21_inverse_matrix");
  TCase *tc5_1 = tcase_create("s21_inverse_matrix");
  Suite *s6 = suite_create("s21_mult_matrix");
  TCase *tc6_1 = tcase_create("s21_mult_matrix");
  Suite *s7 = suite_create("s21_mult_number");
  TCase *tc7_1 = tcase_create("s21_mult_number");
  Suite *s8 = suite_create("s21_remove_matrix");
  TCase *tc8_1 = tcase_create("s21_remove_matrix");
  Suite *s9 = suite_create("s21_sub_matrix");
  TCase *tc9_1 = tcase_create("s21_sub_matrix");
  Suite *s10 = suite_create("s21_sum_matrix");
  TCase *tc10_1 = tcase_create("s21_sum_matrix");
  Suite *s11 = suite_create("s21_transpose_matrix");
  TCase *tc11_1 = tcase_create("s21_transpose_matrix");
  ...
  tcase_add_test(tc2_1, s21_create_matrix_test_1);
  tcase_add_test(tc2_1, s21_create_matrix_test_2);
  tcase_add_test(tc2_1, s21_create_matrix_test_3);
  suite_add_tcase(s3, tc3_1);
  tcase_add_test(tc3_1, s21_determinant_matrix_test_1);
  tcase_add_test(tc3_1, s21_determinant_matrix_test_2);
  tcase_add_test(tc3_1, s21_determinant_matrix_test_3);
  tcase_add_test(tc3_1, s21_determinant_matrix_test_4);
  tcase_add_test(tc3_1, s21_determinant_matrix_test_5);
  tcase_add_test(tc3_1, s21_determinant_matrix_test_6);
  tcase_add_test(tc3_1, s21_determinant_matrix_test_7);
  suite_add_tcase(s4, tc4_1);
  tcase_add_test(tc4_1, s21_eq_matrix_test_1);
  tcase_add_test(tc4_1, s21_eq_matrix_test_2);
  tcase_add_test(tc4_1, s21_eq_matrix_test_3);
  tcase_add_test(tc4_1, s21_eq_matrix_test_4);
  tcase_add_test(tc4_1, s21_eq_matrix_test_5);
  suite_add_tcase(s5, tc5_1);
  tcase_add_test(tc5_1, s21_inverse_matrix_simple1);
  tcase_add_test(tc5_1, s21_inverse_matrix_simple_2x1);
  ...
  tcase_add_test(tc6_1, s21_mult_matrix_test_1);
  tcase_add_test(tc6_1, s21_mult_matrix_test_2);
  tcase_add_test(tc6_1, s21_mult_matrix_test_3);
  tcase_add_test(tc6_1, s21_mult_matrix_test_4);
  tcase_add_test(tc6_1, s21_mult_matrix_test_5);
  suite_add_tcase(s7, tc7_1);
  tcase_add_test(tc7_1, s21_mult_number1);
  tcase_add_test(tc7_1, s21_mult_number2);
  tcase_add_test(tc7_1, s21_mult_number3);
  suite_add_tcase(s8, tc8_1);
  tcase_add_test(tc8_1, s21_remove_matrix_test_1);
  tcase_add_test(tc8_1, s21_remove_matrix_test_2);
  tcase_add_test(tc8_1, s21_remove_matrix_test_3);
  suite_add_tcase(s9, tc9_1);
  tcase_add_test(tc9_1, s21_sub_matrix_test_1);
  tcase_add_test(tc9_1, s21_sub_matrix_test_2);
  tcase_add_test(tc9_1, s21_sub_matrix_test_3);
  tcase_add_test(tc9_1, s21_sub_matrix_test_4);
  tcase_add_test(tc9_1, s21_sub_matrix_test_5);
  suite_add_tcase(s10, tc10_1);
  tcase_add_test(tc10_1, s21_sum_matrix_test_1);
  tcase_add_test(tc10_1, s21_sum_matrix_test_2);
  tcase_add_test(tc10_1, s21_sum_matrix_test_3);
  tcase_add_test(tc10_1, s21_sum_matrix_test_4);
  tcase_add_test(tc10_1, s21_sum_matrix_test_5);
  tcase_add_test(tc10_1, s21_sum_matrix_test_6);
  suite_add_tcase(s11, tc11_1);
  tcase_add_test(tc11_1, s21_transpose_matrix_test_1);
  tcase_add_test(tc11_1, s21_transpose_matrix_test_2);
  tcase_add_test(tc11_1, s21_transpose_matrix_test_3);
  tcase_add_test(tc11_1, s21_transpose_matrix_test_4);
  tcase_add_test(tc11_1, s21_transpose_matrix_test_5);
